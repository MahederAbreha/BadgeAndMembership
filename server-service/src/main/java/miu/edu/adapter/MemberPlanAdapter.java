...
public class MemberPlanAdapter {
    public MemberPlanDTO entityToDTO(Member member){
        return new MemberPlanDTO(member.getId(), member.getFirstname(), member.getLastname(), member.getEmail());
    }
    ...
    public Member DtoToEntity(MemberPlanDTO memberDTO){
        return new Member(memberDTO.getId(), memberDTO.getFirstname(), memberDTO.getLastname(), memberDTO.getEmail());
    }
